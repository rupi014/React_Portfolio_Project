...
import RichTextEditor from "../forms/rich-text-edior";
...
export default class BlogForm extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://rubensballester.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"   
        }
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({ 
                ...
                apiUrl: `https://rubensballester.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,	
                apiAction: "patch"    
            });
            }   
        }
    ...
    handleSubmit(event) {
        ...
        .then(response => {
            ...
            if (this.props.editMode) {
                ...
                this.props.hanleSuccessfullFormSubmission(response.data.portfolio_blog);
            }
